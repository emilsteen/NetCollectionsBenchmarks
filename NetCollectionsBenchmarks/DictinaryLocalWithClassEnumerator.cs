...
{
	internal class DictinaryLocalWithClassEnumerator<TKey, TValue> : DictionaryLocalBase<TKey, TValue>
	{
		public DictinaryLocalWithClassEnumerator() : base(0, null) { }

		public DictinaryLocalWithClassEnumerator(IEnumerable<KeyValuePair<TKey, TValue>> collection) : base(collection, null) { }
