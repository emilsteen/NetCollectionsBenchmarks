...
namespace System.Collections.Generic
{
	...
	public class DictionaryLocalBase<TKey, TValue> // : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback where TKey : notnull
	{
		...
		public DictionaryLocalBase() : this(0, null) { }

		public DictionaryLocalBase(int capacity) : this(capacity, null) { }

		public DictionaryLocalBase(IEqualityComparer<TKey>? comparer) : this(0, comparer) { }

		public DictionaryLocalBase(int capacity, IEqualityComparer<TKey>? comparer)
		{
			if (capacity < 0)
			{
		...
		public DictionaryLocalBase(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

		public DictionaryLocalBase(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer) :
		...
		public DictionaryLocalBase(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null) { }

		public DictionaryLocalBase(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer) :
		...
		private void AddRange(IEnumerable<KeyValuePair<TKey, TValue>> collection)
		{
			...
			if (collection.GetType() == typeof(DictionaryLocalBase<TKey, TValue>))
			{
				DictionaryLocalBase<TKey, TValue> source = (DictionaryLocalBase<TKey, TValue>)collection;
		...
		/*
		protected DictionaryLocalStructEnumerator(SerializationInfo info, StreamingContext context)
		{
		...
		*/
		...
		public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
		{
			...
			public KeyCollection(DictionaryLocalBase<TKey, TValue> dictionary)
			{
				if (dictionary == null)
				{
					ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
			...
			public struct Enumerator : IEnumerator<TKey>, IEnumerator
			{
				...
				internal Enumerator(DictionaryLocalBase<TKey, TValue> dictionary)
				{
					_dictionary = dictionary;
		...
		public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
		{
			...
			public ValueCollection(DictionaryLocalBase<TKey, TValue> dictionary)
			{
				if (dictionary == null)
				{
					ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
	...
	{
		public static object Arg_ArrayPlusOffTooSmall { get; internal set; }
		public static object NotSupported_KeyCollectionSet { get; internal set; }
		public static object Arg_RankMultiDimNotSupported { get; internal set; }
		public static object Arg_NonZeroLowerBound { get; internal set; }
		public static object NotSupported_ValueCollectionSet { get; internal set; }
	}
	...
	{
		internal static IEqualityComparer<string> GetStringComparer<TKey>(IEqualityComparer<TKey> equalityComparer)
		{
			throw new NotImplementedException();
		}

		internal IEqualityComparer<object> GetRandomizedEqualityComparer()
		{
			throw new NotImplementedException();
		}
	}
	...
	{
		public static uint HashCollisionThreshold { get; internal set; }

		internal static int ExpandPrime(int count)
		{
			return 17;
		}

		internal static int GetPrime(int capacity)
		{
			return 17;
		}
	}
	...
	{
		internal static object capacity;
		internal static object dictionary;
		internal static object collection;
		internal static object key;
		internal static object array;
	}

	internal class ThrowHelper
	{
		internal static void ThrowAddingDuplicateWithKeyArgumentException<TKey>(TKey key)
		{
			throw new NotImplementedException();
		}

		internal static void ThrowArgumentException(object arg_ArrayPlusOffTooSmall)
		{
			throw new NotImplementedException();
		}
		...
		internal static void ThrowArgumentNullException(object dictionary)
		{
			throw new NotImplementedException();
		}
		...
		internal static void ThrowNotSupportedException(object notSupported_KeyCollectionSet)
		{
			throw new NotImplementedException();
		}
	}
