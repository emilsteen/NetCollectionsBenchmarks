...
namespace System.Collections.Generic
{
    ...
    public class SortedListLocalBase<TKey, TValue> // :
        // IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue> where TKey : notnull
    {
        public TKey[] keys; // Do not rename (binary serialization)
        public TValue[] values; // Do not rename (binary serialization)
        ...
        // all entries added to the sorted list.
        //
        public SortedListLocalBase(int capacity)
        {
        ...
        //
        public SortedListLocalBase(IComparer<TKey>? comparer)
            : this()
        {
            if (comparer != null)
            {
        ...
        //
        public SortedListLocalBase(int capacity, IComparer<TKey>? comparer)
            : this(comparer)
        {
            Capacity = capacity;
        }
        ...
        //
        public SortedListLocalBase(IDictionary<TKey, TValue> dictionary)
        ...
        // subsequently added to the sorted list.
        //
        public SortedListLocalBase(IDictionary<TKey, TValue> dictionary, IComparer<TKey>? comparer)
        ...
        */
        ...
        private sealed class SortedListKeyEnumerator : IEnumerator<TKey>, IEnumerator
        {
            ...
            internal SortedListKeyEnumerator(SortedListLocalBase<TKey, TValue> sortedList)
            {
                _sortedList = sortedList;
        ...
        private sealed class SortedListValueEnumerator : IEnumerator<TValue>, IEnumerator
        {
            ...
            internal SortedListValueEnumerator(SortedListLocalBase<TKey, TValue> sortedList)
            {
                _sortedList = sortedList;
                _version = sortedList.version;
            }
        ...
        {
            private readonly SortedListLocalBase<TKey, TValue> _dict; // Do not rename (binary serialization)

            internal KeyList(SortedListLocalBase<TKey, TValue> dictionary)
            {
                _dict = dictionary;
            }
        ...
        public sealed class ValueList : IList<TValue>, ICollection
        {
            ...
            internal ValueList(SortedListLocalBase<TKey, TValue> dictionary)
            {
                _dict = dictionary;
            }
		...
		internal class SR
		{
			public static object Argument_AddingDuplicate { get; internal set; }
			public static string? ArgumentOutOfRange_SmallCapacity { get; internal set; }
			public static string NotSupported_SortedListNestedWrite { get; internal set; }
			public static string Arg_RankMultiDimNotSupported { get; internal set; }
			public static string Argument_IncompatibleArrayType { get; internal set; }
			public static string NotSupported_KeyCollectionSet { get; internal set; }
			public static string? ArgumentOutOfRange_IndexMustBeLess { get; internal set; }
			public static string InvalidOperation_EnumFailedVersion { get; internal set; }
			public static string InvalidOperation_EnumOpCantHappen { get; internal set; }

			internal static string Format(object argument_AddingDuplicate, TKey key)
			{
